...
function authorizeUser(authService) {
    return function (target, propName, descriptor) {
        ...
        descriptor.get = function () {
            ...
            if (!hasAccess) {
                throw new Error(" You are not authorized to view this info");
            }
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [])
], User2.prototype, "creditCardNumber", null);
const user1 = new User2("John Doe", 30, "ABCD-1234");
